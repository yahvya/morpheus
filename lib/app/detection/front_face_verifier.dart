...
class FrontFaceVerifier extends Verifier{
  @override
  Future<bool> verify(CameraDescription camera,CameraImage frame) async{
    try{
      ...
      return
        (foundedFace.contours[FaceContourType.lowerLipTop] != null || foundedFace.contours[FaceContourType.lowerLipBottom] != null) &&
        (foundedFace.contours[FaceContourType.upperLipTop] != null || foundedFace.contours[FaceContourType.upperLipBottom] != null);
    }
    catch(_){
      return false;
    }
