...
while True:
    ...
    # Calculate the normalized coordinates of the two points.
        landmark1_normalized_x = results.multi_face_landmarks[0].landmark[93].x
        landmark1_normalized_y = results.multi_face_landmarks[0].landmark[93].y
        landmark2_normalized_x = results.multi_face_landmarks[0].landmark[323].x
        landmark2_normalized_y = results.multi_face_landmarks[0].landmark[323].y
